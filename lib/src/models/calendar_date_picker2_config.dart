...
typedef CalendarScrollViewMonthYearBuilder = Widget Function(DateTime monthDate);

/// Builder for the mode picker widget
///
/// [isMonthPicker] will be true if function is called to build month picker
typedef CalendarModePickerBuilder = Widget? Function({required DateTime monthDate, bool? isMonthPicker});

/// Handler for the text displayed in the mode picker
///
/// [isMonthPicker] will be true if function is called for month picker text
typedef CalendarModePickerTextHandler = String? Function({required DateTime monthDate, bool? isMonthPicker});
...
class CalendarDatePicker2Config {
  CalendarDatePicker2Config({
    ...
    this.dynamicCalendarRows,
        ...
        firstDate = DateUtils.dateOnly(firstDate ?? DateTime(2015, 1, 1)),
        lastDate = DateUtils.dateOnly(lastDate ?? DateTime.now()),
        currentDate = currentDate ?? DateUtils.dateOnly(DateTime.now()),
        calendarViewMode = isOnlyMonthRange == true
            ? (calendarViewMode == CalendarDatePicker2Mode.day
                ? CalendarDatePicker2Mode.month
                : (calendarViewMode ?? CalendarDatePicker2Mode.day))
            : (calendarViewMode ?? CalendarDatePicker2Mode.day),
        isOnlyMonthRange = isOnlyMonthRange ?? false,
        needSameYear = needSameYear ?? false,
        needSameMonth = needSameMonth ?? false;
  ...
  final bool isOnlyMonthRange;
  final bool needSameYear;
  final bool needSameMonth;
  ...
  /// Custom page controller for the calendar month view mode
  final PageController? monthPageViewController;
  ...
  /// Function to provide full control over day widget UI
  final CalendarDayBuilder? monthRangeBuilder;
  ...
  CalendarDatePicker2Config copyWith({
    ...
    CalendarDayBuilder? monthRangeBuilder,
    ...
    return CalendarDatePicker2Config(
      ...
      monthPageViewController: monthPageViewController ?? this.monthPageViewController,
      ...
      monthRangeBuilder: monthRangeBuilder ?? this.monthRangeBuilder,
...
class CalendarDatePicker2WithActionButtonsConfig extends CalendarDatePicker2Config {
  CalendarDatePicker2WithActionButtonsConfig({
    ...
    this.buttonPadding,
          ...
          isOnlyMonthRange: isOnlyMonthRange,
          needSameYear: needSameYear,
          needSameMonth: needSameMonth,
        );
  ...
  /// Text style for day range
  final TextStyle? dayRangeTextStyle;
  ...
  CalendarDatePicker2WithActionButtonsConfig copyWith({
    ...
    return CalendarDatePicker2WithActionButtonsConfig(
      ...
      scrollViewController: scrollViewController ?? this.scrollViewController,
      dynamicCalendarRows: dynamicCalendarRows ?? this.dynamicCalendarRows,
      isOnlyMonthRange: isOnlyMonthRange ?? this.isOnlyMonthRange,
      needSameYear: needSameYear ?? this.needSameYear,
      needSameMonth: needSameMonth ?? this.needSameMonth,
    );
  }
}
